export default {
    ...
    methods : {
        ListUsers(page){
            let me = this;
            var url = '/reports?page='+page+'&search='+this.search+'&criterion='+this.criterion+'&status='+this.status+'&date='+this.date+'&type='+this.type;
             axios.get(url)
            .then(function (response) {
                var respuesta= response.data;
                console.log(respuesta);
                me.dataUsers = respuesta.Tickets.data;
